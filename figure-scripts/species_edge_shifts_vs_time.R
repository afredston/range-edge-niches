...
ggsave(ex1gg, dpi=160, width=4, height=4, filename=here("results",paste0("example_edge_",ex.spp1,".png")))
ggsave(ex2gg, dpi=160, width=4, height=4, filename=here("results",paste0("example_edge_",ex.spp2,".png")))
ggsave(ex3gg, dpi=160, width=4, height=4, filename=here("results",paste0("example_edge_",ex.spp3,".png")))
